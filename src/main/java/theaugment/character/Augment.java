...
import theaugment.cards.attacks.StunningStrike;
...
public class Augment extends CustomPlayer {
    //Stats
    ...
    //Strings
    private static final String ID = makeID("Augment"); //This should match whatever you have in the CharacterStrings.json file
    ...
    //This static class is necessary to avoid certain quirks of Java classloading when registering the theaugment.character.
    public static class Meta {
        //These are used to identify your theaugment.character, as well as your theaugment.character's card color.
        //Library color is basically the same as card color, but you need both because that's how the game was made.
        @SpireEnum
        public static PlayerClass Augment;
        @SpireEnum(name = "CHARACTER_AUGMENT_COLOR") // These two MUST match. Change it to something unique for your theaugment.character.
        public static AbstractCard.CardColor CARD_COLOR;
        @SpireEnum(name = "CHARACTER_AUGMENT_COLOR") @SuppressWarnings("unused")
        ...
        public static void registerCharacter() {
            BaseMod.addCharacter(new Augment(), CHAR_SELECT_BUTTON, CHAR_SELECT_PORTRAIT);
        }
    }
    ...
    public void doCharSelectScreenSelectEffect() {
        //This occurs when you click the theaugment.character's button in the theaugment.character select screen.
    ...
    //This is used to display the theaugment.character's information on the theaugment.character selection screen.
    @Override
    ...
    public AbstractPlayer newInstance() {
        //Makes a new instance of your theaugment.character class.
        return new Augment();
    }
}
